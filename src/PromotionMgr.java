						...
						switch(userInput) {
							...
							case 2:
								...
								if (description.charAt(0) != '-' && description.charAt(1) != '1'){
									...
									System.out.println("\nSuccessfully updated description for promotion " + promotions.get(promoFound).getName() + "\n");
								} else {
							...
							case 3:
								...
								if (price != -1){
									...
									System.out.println("\nSuccessfully updated price for promotion " + promotions.get(promoFound).getName() + "\n");
								} else {
